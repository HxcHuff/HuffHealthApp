...
export interface ActionHubCategory {
  title: string;
  actions: ActionHubItem[];
}

export const actionHubCategories: ActionHubCategory[] = [
  {
...
export function getActionCategoryByTitle(title: string): ActionHubCategory | undefined {
  return actionHubCategories.find((category) => category.title === title);
}
