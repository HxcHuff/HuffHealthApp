...
export default function ImportClientsPage() {
  ...
  return (
    <>
      <PageHeader title="Import Clients" description="Upload a CSV or Excel file to bulk import clients" />
      ...
      {step === "upload" && (
        ...
        >
          ...
          <p className="text-xs text-gray-500 mt-1">
            Supports CSV, XLS, XLSX files. Imported records will be created as enrolled clients.
          </p>
        </div>
      )}
      ...
      {step === "mapping" && parsedFile && (
        <div className="space-y-4">
          <div className="rounded-xl border border-gray-200 bg-white p-6">
            ...
            <h3 className="text-sm font-semibold text-gray-900 mb-3">Map Columns to Client Fields</h3>
      ...
      {step === "preview" && parsedFile && (
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            ...
            >
              Import {parsedFile.totalRows} Clients
            </button>
          </div>
        </div>
      )}
